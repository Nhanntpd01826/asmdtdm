                    ...
                    <form method="get" action="sanphamServlet" enctype="multipart/form-data" style="margin-top: 20px;">
                        <div class="col-sm-11">   
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="vui lòng nhập mã sản phẩm" name="maSP" value="${PRODUCT.get(0)}">
                            </div>
                            <div class="form-group">
                                <label>Tên sản phẩm:</label>
                                <input type="text" class="form-control" placeholder="vui lòng nhập tên sản phẩm" name="name" value="${PRODUCT.get(1)}">
                            </div>
                            <div class="form-group">
                                <label>Loại sản phẩm:</label>
                                <input type="text" class="form-control" placeholder="vui lòng nhập loại sản phẩm" name="type" value="${PRODUCT.get(7)}">
                            </div>
                            <div class="form-group">
                                <label for="pwd">Nhà sản xuất:</label>
                                <input type="text" class="form-control" placeholder="vui lòng nhập nhà sản xuất" name="producer" value="${PRODUCT.get(2)}">
                            </div>   
                            <div class="form-group">
                                <label for="pwd">Giá nhập:</label>
                                <input type="number" class="form-control" placeholder="vui lòng nhập giá nhập sản phẩm" name="price1" value="${PRODUCT.get(3)}">
                            </div>
                            <div class="form-group">
                                <label for="pwd">Giá bán:</label>
                                <input type="number" class="form-control" placeholder="vui lòng nhập giá bán sản phẩm" name="price2" value="${PRODUCT.get(4)}">
                            </div>
                            <div class="form-group">
                                <label for="pwd">Thuế:</label>
                                <input type="text" class="form-control" placeholder="vui lòng nhập thuế cho sản phẩm" name="thue" value="${PRODUCT.get(5)}">
                            </div>
                            <div class="form-group">
